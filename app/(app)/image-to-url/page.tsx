  ...
  return (
    <div className="p-6 max-w-md mx-auto">
      ...
      <div className="mb-4">
        ...
        <div 
          className="border-2 border-dashed border-gray-300 p-4 text-center cursor-pointer rounded-lg hover:bg-gray-50 transition-colors mt-2"
          onClick={() => document.getElementById('fileInput')?.click()}
          onPaste={handlePaste as any}
        >
          <p className="text-gray-500">
            {isPasteEnabled ? 
              "Drag & drop an image here, or click to browse. You can also paste (Ctrl+V) an image directly." : 
      ...
      {previewUrl && (
        <div className="max-w-full overflow-hidden rounded-lg shadow-lg mb-4">
          <img
            src={previewUrl}
            alt="Preview"
            className="w-full h-auto object-contain mb-2"
